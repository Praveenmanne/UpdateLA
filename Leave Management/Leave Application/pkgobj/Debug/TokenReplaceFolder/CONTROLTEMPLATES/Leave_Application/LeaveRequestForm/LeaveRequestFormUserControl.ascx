...
<script type="text/javascript" language="javascript ">
    ...
    //            var selectedLeave = document.getElementById("<%= ddlTypeofLeave.ClientID %>").options[document.getElementById("<%= ddlTypeofLeave.ClientID %>").selectedIndex].value;
    //            debugger;
    //            if (selectedLeave == "Optional") {
    //                document.getElementById("Selecteddates").display = "none;";
    //            }
    //            else {
    //                document.getElementById("optinalDates").display = "none;";
    //            }
    ...
    function ishalfday() {
        ...
        //            durationdays = parseFloat(durationValue) - 0.5;
        //            document.getElementById("<%= txtDuration.ClientID %>").value = durationdays;
        //            document.getElementById("<%= lblDuration.ClientID %>").innerText = durationdays;
        ////            durationValue = countWorkingDays;
        //            
